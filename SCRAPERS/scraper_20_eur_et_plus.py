#!/usr/bin/env python3
"""
SCRAPER AMAZON - CATÉGORIE: 20 EUR et plus
URL de base: https://www.amazon.fr/s?i=stripbooks&rh=n%3A301061%2Cp_72%3A184904031%2Cp_36%3A2000-&s=popularity-rank&dc&content-id=amzn1.sym.fd35f9f2-1aca-4d5e-befe-a52647ead21e&pd_rd_r=23c60f36-c6f1-43fb-8fb4-59d764073c73&pd_rd_w=b7690&pd_rd_wg=TcyWG&pf_rd_p=fd35f9f2-1aca-4d5e-befe-a52647ead21e&pf_rd_r=RH369CG6CY05Z7ZRC5V7&qid=1757686819&rnid=389153011&ref=sr_nr_p_36_4&ds=v1%3AR5AIBePwU9mUyuoGhxKXV%2F7ktGqIdzCjQvGixFIoqSU
...
class ScraperAmazon20Euretplus:
    def __init__(self):
        """Initialise le scraper pour 20 EUR et plus"""
        self.nom_categorie = "20 EUR et plus"
        self.nom_fichier = "20_eur_et_plus"
...
if __name__ == "__main__":
    scraper = ScraperAmazon20Euretplus()
