#!/usr/bin/env python3
"""
SCRAPER AMAZON - CATÉGORIE: 4 Stars& plus
URL de base: https://www.amazon.fr/s?i=stripbooks&rh=n%3A301061&s=popularity-rank&dc&content-id=amzn1.sym.fd35f9f2-1aca-4d5e-befe-a52647ead21e&pd_rd_r=23c60f36-c6f1-43fb-8fb4-59d764073c73&pd_rd_w=b7690&pd_rd_wg=TcyWG&pf_rd_p=fd35f9f2-1aca-4d5e-befe-a52647ead21e&pf_rd_r=RH369CG6CY05Z7ZRC5V7&qid=1757686819&rnid=184891031&ref=sr_nr_p_72_1&ds=v1%3AfwE5tOrQXJodHdEdMlqGCwCOZM9GtdEJ4G0U%2FFfTlsw
...
class ScraperAmazon4Starsplus:
    def __init__(self):
        """Initialise le scraper pour 4 Stars& plus"""
        self.nom_categorie = "4 Stars& plus"
        self.nom_fichier = "4_stars_plus"
...
if __name__ == "__main__":
    scraper = ScraperAmazon4Starsplus()
