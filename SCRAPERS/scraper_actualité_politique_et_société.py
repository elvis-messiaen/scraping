#!/usr/bin/env python3
"""
SCRAPER AMAZON AMÉLIORÉ V3.0 - ACTUALITÉ, POLITIQUE ET SOCIÉTÉ
=======================================================================
Catégorie: Actualité, Politique et Société
URL: https://www.amazon.fr/s?k=Actualité,+Politique+et+Société&i=stripbooks
...
class ScraperAmazonActualitéPolitiqueetSociété(ScraperAmazonAmeliore):
    """
    Scraper spécialisé pour: Actualité, Politique et Société
    ...
    def __init__(self, mode_forcee: bool = False):
        """
        Initialise le scraper v3.0 pour Actualité, Politique et Société

        Args:
            mode_forcee (bool): Force la mise à jour de TOUS les livres existants (défaut: False)
        """
        super().__init__(
            nom_categorie="Actualité, Politique et Société",
            url_categorie="https://www.amazon.fr/s?k=Actualité,+Politique+et+Société&i=stripbooks",
...
def main(mode_forcee: bool = False):
    ...
    """
    scraper = ScraperAmazonActualitéPolitiqueetSociété(mode_forcee=mode_forcee)

    print(f"🚀 Démarrage du scraper v3.0 pour: Actualité, Politique et Société")
    ...
    if total_nouveaux > 0:
        print(f"\n✅ SUCCÈS: {total_nouveaux} nouveaux livres ajoutés pour Actualité, Politique et Société")
    else:
        print(f"\n✅ TERMINÉ: Base de données à jour pour Actualité, Politique et Société")
