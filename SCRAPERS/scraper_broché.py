#!/usr/bin/env python3
"""
SCRAPER AMAZON - CATÉGORIE: Broché
URL de base: https://www.amazon.fr/s?i=stripbooks&rh=n%3A301061%2Cp_72%3A184904031%2Cp_n_binding_browse-bin%3A3973586031&s=popularity-rank&dc&content-id=amzn1.sym.fd35f9f2-1aca-4d5e-befe-a52647ead21e&pd_rd_r=23c60f36-c6f1-43fb-8fb4-59d764073c73&pd_rd_w=b7690&pd_rd_wg=TcyWG&pf_rd_p=fd35f9f2-1aca-4d5e-befe-a52647ead21e&pf_rd_r=RH369CG6CY05Z7ZRC5V7&qid=1757686819&rnid=492479011&ref=sr_nr_p_n_binding_browse-bin_1&ds=v1%3AC06iXN7KpKIKwBhQW9vbdiLTcQZbtUX2JadagpLq22o
...
class ScraperAmazonBroché:
    def __init__(self):
        """Initialise le scraper pour Broché"""
        self.nom_categorie = "Broché"
        self.nom_fichier = "broché"
