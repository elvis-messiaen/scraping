#!/usr/bin/env python3
"""
SCRAPER AMAZON - CATÉGORIE: D'auteurs Collectif
URL de base: https://www.amazon.fr/s?i=stripbooks&rh=n%3A301061%2Cp_72%3A184904031%2Cp_lbr_books_authors_browse-bin%3AD%2527auteurs%2BCollectif&s=popularity-rank&dc&content-id=amzn1.sym.fd35f9f2-1aca-4d5e-befe-a52647ead21e&pd_rd_r=23c60f36-c6f1-43fb-8fb4-59d764073c73&pd_rd_w=b7690&pd_rd_wg=TcyWG&pf_rd_p=fd35f9f2-1aca-4d5e-befe-a52647ead21e&pf_rd_r=RH369CG6CY05Z7ZRC5V7&qid=1757686819&rnid=545982031&ref=sr_nr_p_lbr_books_authors_browse-bin_4&ds=v1%3AgvO8CJzlaNPagCqzXcjz1ovb88u%2BcX5SrOQMg%2B0kJgg
...
class ScraperAmazonDauteurscollectif:
    def __init__(self):
        """Initialise le scraper pour D'auteurs Collectif"""
        self.nom_categorie = "D'auteurs Collectif"
        self.nom_fichier = "d_auteurs_collectif"
