#!/usr/bin/env python3
"""
SCRAPER AMAZON - CATÉGORIE: D'occasion
URL de base: https://www.amazon.fr/s?i=stripbooks&rh=n%3A301061%2Cp_72%3A184904031%2Cp_n_condition-type%3A15135267031&s=popularity-rank&dc&content-id=amzn1.sym.fd35f9f2-1aca-4d5e-befe-a52647ead21e&pd_rd_r=23c60f36-c6f1-43fb-8fb4-59d764073c73&pd_rd_w=b7690&pd_rd_wg=TcyWG&pf_rd_p=fd35f9f2-1aca-4d5e-befe-a52647ead21e&pf_rd_r=RH369CG6CY05Z7ZRC5V7&qid=1757686819&rnid=15135264031&ref=sr_nr_p_n_condition-type_2&ds=v1%3Afpe2k82fmJ%2F8oWovABJLq6%2BpYXJP3tMnyrDOiARcJk8
...
class ScraperAmazonDoccasion:
    def __init__(self):
        """Initialise le scraper pour D'occasion"""
        self.nom_categorie = "D'occasion"
        self.nom_fichier = "d_occasion"
