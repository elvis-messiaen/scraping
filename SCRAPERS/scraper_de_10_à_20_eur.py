#!/usr/bin/env python3
"""
SCRAPER AMAZON - CATÉGORIE: de 10 à 20 EUR
URL de base: https://www.amazon.fr/s?i=stripbooks&rh=n%3A301061%2Cp_72%3A184904031%2Cp_36%3A1000-2000&s=popularity-rank&dc&content-id=amzn1.sym.fd35f9f2-1aca-4d5e-befe-a52647ead21e&pd_rd_r=23c60f36-c6f1-43fb-8fb4-59d764073c73&pd_rd_w=b7690&pd_rd_wg=TcyWG&pf_rd_p=fd35f9f2-1aca-4d5e-befe-a52647ead21e&pf_rd_r=RH369CG6CY05Z7ZRC5V7&qid=1757686819&rnid=389153011&ref=sr_nr_p_36_3&ds=v1%3AKBhsv%2B4zxPCDAe1Xd0bRpa6ZxoimrZl820h69vIY%2Bl8
...
class ScraperAmazonDe10À20Eur:
    def __init__(self):
        """Initialise le scraper pour de 10 à 20 EUR"""
        self.nom_categorie = "de 10 à 20 EUR"
        self.nom_fichier = "de_10_à_20_eur"
...
if __name__ == "__main__":
    scraper = ScraperAmazonDe10À20Eur()
