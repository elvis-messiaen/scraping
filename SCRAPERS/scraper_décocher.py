#!/usr/bin/env python3
"""
SCRAPER AMAZON - CATÉGORIE: Décocher
URL de base: https://www.amazon.fr/s?i=stripbooks&rh=n%3A301061&s=popularity-rank&dc&content-id=amzn1.sym.fd35f9f2-1aca-4d5e-befe-a52647ead21e&pd_rd_r=23c60f36-c6f1-43fb-8fb4-59d764073c73&pd_rd_w=b7690&pd_rd_wg=TcyWG&pf_rd_p=fd35f9f2-1aca-4d5e-befe-a52647ead21e&pf_rd_r=RH369CG6CY05Z7ZRC5V7&qid=1757686819&ref=sr_ex_p_72_0&ds=v1%3AGxy6L4w4nRA3mX9juBqxcD7DAdWhEqBEVJ0sMD3c2ZI
...
class ScraperAmazonDécocher:
    def __init__(self):
        """Initialise le scraper pour Décocher"""
        self.nom_categorie = "Décocher"
        self.nom_fichier = "décocher"
