#!/usr/bin/env python3
"""
SCRAPER AMAZON AMÉLIORÉ V3.0 - INFORMATIQUE ET INTERNET
================================================================
Catégorie: Informatique et internet
URL: https://www.amazon.fr/s?k=Informatique+et+internet&i=stripbooks
...
class ScraperAmazonInformatiqueetinternet(ScraperAmazonAmeliore):
    """
    Scraper spécialisé pour: Informatique et internet
    ...
    def __init__(self, mode_forcee: bool = False):
        """
        Initialise le scraper v3.0 pour Informatique et internet

        Args:
            mode_forcee (bool): Force la mise à jour de TOUS les livres existants (défaut: False)
        """
        super().__init__(
            nom_categorie="Informatique et internet",
            url_categorie="https://www.amazon.fr/s?k=Informatique+et+internet&i=stripbooks",
...
def main(mode_forcee: bool = False):
    ...
    """
    scraper = ScraperAmazonInformatiqueetinternet(mode_forcee=mode_forcee)

    print(f"🚀 Démarrage du scraper v3.0 pour: Informatique et internet")
    ...
    if total_nouveaux > 0:
        print(f"\n✅ SUCCÈS: {total_nouveaux} nouveaux livres ajoutés pour Informatique et internet")
    else:
        print(f"\n✅ TERMINÉ: Base de données à jour pour Informatique et internet")
