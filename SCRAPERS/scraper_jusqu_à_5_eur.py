#!/usr/bin/env python3
"""
SCRAPER AMAZON - CATÉGORIE: Jusqu’à 5 EUR
URL de base: https://www.amazon.fr/s?i=stripbooks&rh=n%3A301061%2Cp_72%3A184904031%2Cp_36%3A-500&s=popularity-rank&dc&content-id=amzn1.sym.fd35f9f2-1aca-4d5e-befe-a52647ead21e&pd_rd_r=23c60f36-c6f1-43fb-8fb4-59d764073c73&pd_rd_w=b7690&pd_rd_wg=TcyWG&pf_rd_p=fd35f9f2-1aca-4d5e-befe-a52647ead21e&pf_rd_r=RH369CG6CY05Z7ZRC5V7&qid=1757686819&rnid=389153011&ref=sr_nr_p_36_1&ds=v1%3A21E2S9rtnECLuKAzRaRuWtfhV%2BT4jmw1Bxm7WHV%2FGt0
...
class ScraperAmazonJusquà5Eur:
    def __init__(self):
        """Initialise le scraper pour Jusqu’à 5 EUR"""
        self.nom_categorie = "Jusqu’à 5 EUR"
        self.nom_fichier = "jusqu_à_5_eur"
...
if __name__ == "__main__":
    scraper = ScraperAmazonJusquà5Eur()
