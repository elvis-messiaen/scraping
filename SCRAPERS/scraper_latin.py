#!/usr/bin/env python3
"""
SCRAPER AMAZON AMÉLIORÉ V3.0 - LATIN
=============================================
Catégorie: Latin
URL: https://www.amazon.fr/s?k=Latin&i=stripbooks
...
class ScraperAmazonLatin(ScraperAmazonAmeliore):
    """
    Scraper spécialisé pour: Latin
    ...
    def __init__(self, mode_forcee: bool = False):
        """
        Initialise le scraper v3.0 pour Latin
        ...
        super().__init__(
            nom_categorie="Latin",
            url_categorie="https://www.amazon.fr/s?k=Latin&i=stripbooks",
...
def main(mode_forcee: bool = False):
    ...
    """
    scraper = ScraperAmazonLatin(mode_forcee=mode_forcee)

    print(f"🚀 Démarrage du scraper v3.0 pour: Latin")
    ...
    if total_nouveaux > 0:
        print(f"\n✅ SUCCÈS: {total_nouveaux} nouveaux livres ajoutés pour Latin")
    else:
        print(f"\n✅ TERMINÉ: Base de données à jour pour Latin")
