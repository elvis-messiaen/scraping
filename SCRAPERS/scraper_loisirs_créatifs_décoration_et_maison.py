#!/usr/bin/env python3
"""
SCRAPER AMAZON AMÉLIORÉ V3.0 - LOISIRS CRÉATIFS, DÉCORATION ET MAISON
==============================================================================
Catégorie: Loisirs créatifs, décoration et maison
URL: https://www.amazon.fr/s?k=Loisirs+créatifs,+décoration+et+maison&i=stripbooks
...
class ScraperAmazonLoisirscréatifsdécorationetmaison(ScraperAmazonAmeliore):
    """
    Scraper spécialisé pour: Loisirs créatifs, décoration et maison
    ...
    def __init__(self, mode_forcee: bool = False):
        """
        Initialise le scraper v3.0 pour Loisirs créatifs, décoration et maison

        Args:
            mode_forcee (bool): Force la mise à jour de TOUS les livres existants (défaut: False)
        """
        super().__init__(
            nom_categorie="Loisirs créatifs, décoration et maison",
            url_categorie="https://www.amazon.fr/s?k=Loisirs+créatifs,+décoration+et+maison&i=stripbooks",
...
def main(mode_forcee: bool = False):
    ...
    """
    scraper = ScraperAmazonLoisirscréatifsdécorationetmaison(mode_forcee=mode_forcee)

    print(f"🚀 Démarrage du scraper v3.0 pour: Loisirs créatifs, décoration et maison")
    ...
    if total_nouveaux > 0:
        print(f"\n✅ SUCCÈS: {total_nouveaux} nouveaux livres ajoutés pour Loisirs créatifs, décoration et maison")
    else:
        print(f"\n✅ TERMINÉ: Base de données à jour pour Loisirs créatifs, décoration et maison")
