#!/usr/bin/env python3
"""
SCRAPER AMAZON - CATÉGORIE: Mystère et suspense
URL de base: https://www.amazon.fr/s?i=stripbooks&rh=n%3A301061%2Cn%3A301134%2Cp_72%3A184904031&s=popularity-rank&dc&content-id=amzn1.sym.fd35f9f2-1aca-4d5e-befe-a52647ead21e&pd_rd_r=23c60f36-c6f1-43fb-8fb4-59d764073c73&pd_rd_w=b7690&pd_rd_wg=TcyWG&pf_rd_p=fd35f9f2-1aca-4d5e-befe-a52647ead21e&pf_rd_r=RH369CG6CY05Z7ZRC5V7&qid=1757686819&rnid=301061&ref=sr_nr_n_25&ds=v1%3Ar4m1iMlIf2qCv4b6u5pdx8Z25nrOfvI8FFa7cvOJk48
...
class ScraperAmazonMystèreetsuspense:
    def __init__(self):
        """Initialise le scraper pour Mystère et suspense"""
        self.nom_categorie = "Mystère et suspense"
        self.nom_fichier = "mystère_et_suspense"
...
if __name__ == "__main__":
    scraper = ScraperAmazonMystèreetsuspense()
