#!/usr/bin/env python3
"""
SCRAPER AMAZON - CATÉGORIE: Néerlandais
URL de base: https://www.amazon.fr/s?i=stripbooks&rh=n%3A301061%2Cp_72%3A184904031%2Cp_n_feature_browse-bin%3A5332143031&s=popularity-rank&dc&content-id=amzn1.sym.fd35f9f2-1aca-4d5e-befe-a52647ead21e&pd_rd_r=23c60f36-c6f1-43fb-8fb4-59d764073c73&pd_rd_w=b7690&pd_rd_wg=TcyWG&pf_rd_p=fd35f9f2-1aca-4d5e-befe-a52647ead21e&pf_rd_r=RH369CG6CY05Z7ZRC5V7&qid=1757686819&rnid=5272947031&ref=sr_nr_p_n_feature_browse-bin_12&ds=v1%3A0PUgtMWaYstCh28U0wAxB4rVTktr%2B6Yg5Pfw4f1qXak
...
class ScraperAmazonNéerlandais:
    def __init__(self):
        """Initialise le scraper pour Néerlandais"""
        self.nom_categorie = "Néerlandais"
        self.nom_fichier = "néerlandais"
...
if __name__ == "__main__":
    scraper = ScraperAmazonNéerlandais()
