#!/usr/bin/env python3
"""
SCRAPER AMAZON AMÉLIORÉ V3.0 - POCHE
=============================================
Catégorie: Poche
URL: https://www.amazon.fr/s?k=Poche&i=stripbooks
...
class ScraperAmazonPoche(ScraperAmazonAmeliore):
    """
    Scraper spécialisé pour: Poche
    ...
    def __init__(self, mode_forcee: bool = False):
        """
        Initialise le scraper v3.0 pour Poche
        ...
        super().__init__(
            nom_categorie="Poche",
            url_categorie="https://www.amazon.fr/s?k=Poche&i=stripbooks",
...
def main(mode_forcee: bool = False):
    ...
    """
    scraper = ScraperAmazonPoche(mode_forcee=mode_forcee)

    print(f"🚀 Démarrage du scraper v3.0 pour: Poche")
    ...
    if total_nouveaux > 0:
        print(f"\n✅ SUCCÈS: {total_nouveaux} nouveaux livres ajoutés pour Poche")
    else:
        print(f"\n✅ TERMINÉ: Base de données à jour pour Poche")
