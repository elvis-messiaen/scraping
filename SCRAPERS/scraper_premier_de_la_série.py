#!/usr/bin/env python3
"""
SCRAPER AMAZON - CATÉGORIE: Premier de la série
URL de base: https://www.amazon.fr/s?i=stripbooks&rh=n%3A301061%2Cp_72%3A184904031%2Cp_n_feature_twelve_browse-bin%3A100406699031&s=popularity-rank&dc&content-id=amzn1.sym.fd35f9f2-1aca-4d5e-befe-a52647ead21e&pd_rd_r=23c60f36-c6f1-43fb-8fb4-59d764073c73&pd_rd_w=b7690&pd_rd_wg=TcyWG&pf_rd_p=fd35f9f2-1aca-4d5e-befe-a52647ead21e&pf_rd_r=RH369CG6CY05Z7ZRC5V7&qid=1757686819&rnid=100406680031&ref=sr_nr_p_n_feature_twelve_browse-bin_3&ds=v1%3AGkFYhHapxIUzpEgGm0jJtEmo8fw%2F6zw3nAuM29LyhNM
...
class ScraperAmazonPremierdelasérie:
    def __init__(self):
        """Initialise le scraper pour Premier de la série"""
        self.nom_categorie = "Premier de la série"
        self.nom_fichier = "premier_de_la_série"
...
if __name__ == "__main__":
    scraper = ScraperAmazonPremierdelasérie()
