#!/usr/bin/env python3
"""
SCRAPER AMAZON - CATÉGORIE: Recevez-le d'ici demain
URL de base: https://www.amazon.fr/s?i=stripbooks&rh=n%3A301061%2Cp_72%3A184904031%2Cp_90%3A6828316031&s=popularity-rank&dc&content-id=amzn1.sym.fd35f9f2-1aca-4d5e-befe-a52647ead21e&pd_rd_r=23c60f36-c6f1-43fb-8fb4-59d764073c73&pd_rd_w=b7690&pd_rd_wg=TcyWG&pf_rd_p=fd35f9f2-1aca-4d5e-befe-a52647ead21e&pf_rd_r=RH369CG6CY05Z7ZRC5V7&qid=1757686819&rnid=6828314031&ref=sr_nr_p_90_2&ds=v1%3AcUqm3XDEa7YMkSB%2BwM8PatzROtw2FDv3bXNXeFlePx8
...
class ScraperAmazonRecevezledicidemain:
    def __init__(self):
        """Initialise le scraper pour Recevez-le d'ici demain"""
        self.nom_categorie = "Recevez-le d'ici demain"
        self.nom_fichier = "recevez_le_d_ici_demain"
...
if __name__ == "__main__":
    scraper = ScraperAmazonRecevezledicidemain()
