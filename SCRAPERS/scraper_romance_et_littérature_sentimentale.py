#!/usr/bin/env python3
"""
SCRAPER AMAZON AMÉLIORÉ V3.0 - ROMANCE ET LITTÉRATURE SENTIMENTALE
===========================================================================
Catégorie: Romance et littérature sentimentale
URL: https://www.amazon.fr/s?k=Romance+et+littérature+sentimentale&i=stripbooks
...
class ScraperAmazonRomanceetlittératuresentimentale(ScraperAmazonAmeliore):
    """
    Scraper spécialisé pour: Romance et littérature sentimentale
    ...
    def __init__(self, mode_forcee: bool = False):
        """
        Initialise le scraper v3.0 pour Romance et littérature sentimentale

        Args:
            mode_forcee (bool): Force la mise à jour de TOUS les livres existants (défaut: False)
        """
        super().__init__(
            nom_categorie="Romance et littérature sentimentale",
            url_categorie="https://www.amazon.fr/s?k=Romance+et+littérature+sentimentale&i=stripbooks",
...
def main(mode_forcee: bool = False):
    ...
    """
    scraper = ScraperAmazonRomanceetlittératuresentimentale(mode_forcee=mode_forcee)

    print(f"🚀 Démarrage du scraper v3.0 pour: Romance et littérature sentimentale")
    ...
    if total_nouveaux > 0:
        print(f"\n✅ SUCCÈS: {total_nouveaux} nouveaux livres ajoutés pour Romance et littérature sentimentale")
    else:
        print(f"\n✅ TERMINÉ: Base de données à jour pour Romance et littérature sentimentale")
