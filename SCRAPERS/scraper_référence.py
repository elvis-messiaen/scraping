#!/usr/bin/env python3
"""
SCRAPER AMAZON - CATÉGORIE: Référence
URL de base: https://www.amazon.fr/s?i=stripbooks&rh=n%3A301061%2Cn%3A301147%2Cp_72%3A184904031&s=popularity-rank&dc&content-id=amzn1.sym.fd35f9f2-1aca-4d5e-befe-a52647ead21e&pd_rd_r=23c60f36-c6f1-43fb-8fb4-59d764073c73&pd_rd_w=b7690&pd_rd_wg=TcyWG&pf_rd_p=fd35f9f2-1aca-4d5e-befe-a52647ead21e&pf_rd_r=RH369CG6CY05Z7ZRC5V7&qid=1757686819&rnid=301061&ref=sr_nr_n_8&ds=v1%3AY0luRM1aiDtruhSaLTrAKOUTrmNtDpL%2FkAhGLwAAp7E
...
class ScraperAmazonRéférence:
    def __init__(self):
        """Initialise le scraper pour Référence"""
        self.nom_categorie = "Référence"
        self.nom_fichier = "référence"
...
if __name__ == "__main__":
    scraper = ScraperAmazonRéférence()
