#!/usr/bin/env python3
"""
SCRAPER AMAZON - CATÉGORIE: Sciences, Techniques et Médecine
URL de base: https://www.amazon.fr/s?i=stripbooks&rh=n%3A301061%2Cn%3A301141%2Cp_72%3A184904031&s=popularity-rank&dc&content-id=amzn1.sym.fd35f9f2-1aca-4d5e-befe-a52647ead21e&pd_rd_r=23c60f36-c6f1-43fb-8fb4-59d764073c73&pd_rd_w=b7690&pd_rd_wg=TcyWG&pf_rd_p=fd35f9f2-1aca-4d5e-befe-a52647ead21e&pf_rd_r=RH369CG6CY05Z7ZRC5V7&qid=1757686819&rnid=301061&ref=sr_nr_n_28&ds=v1%3AOhPFA2lfSRoSsamAXtwSW2DSsJqkG9xhpZJ%2BkjbDmYM
...
class ScraperAmazonSciencestechniquesetmédecine:
    def __init__(self):
        """Initialise le scraper pour Sciences, Techniques et Médecine"""
        self.nom_categorie = "Sciences, Techniques et Médecine"
        self.nom_fichier = "sciences_techniques_et_médecine"
...
if __name__ == "__main__":
    scraper = ScraperAmazonSciencestechniquesetmédecine()
