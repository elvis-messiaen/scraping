#!/usr/bin/env python3
"""
SCRAPER AMAZON - CATÉGORIE: Tous les rabais
URL de base: https://www.amazon.fr/s?i=stripbooks&rh=n%3A301061%2Cp_72%3A184904031%2Cp_n_deal_type%3A26902977031&s=popularity-rank&dc&content-id=amzn1.sym.fd35f9f2-1aca-4d5e-befe-a52647ead21e&pd_rd_r=23c60f36-c6f1-43fb-8fb4-59d764073c73&pd_rd_w=b7690&pd_rd_wg=TcyWG&pf_rd_p=fd35f9f2-1aca-4d5e-befe-a52647ead21e&pf_rd_r=RH369CG6CY05Z7ZRC5V7&qid=1757686819&rnid=26902974031&ref=sr_nr_p_n_deal_type_1&ds=v1%3An%2FGcWOqNnpAzJaAqGafIdmhcVN%2FF%2BRldwOeAcM9UmAU
...
class ScraperAmazonTouslesrabais:
    def __init__(self):
        """Initialise le scraper pour Tous les rabais"""
        self.nom_categorie = "Tous les rabais"
        self.nom_fichier = "tous_les_rabais"
...
if __name__ == "__main__":
    scraper = ScraperAmazonTouslesrabais()
