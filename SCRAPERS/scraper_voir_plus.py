#!/usr/bin/env python3
"""
MODÈLE DE SCRAPER AMAZON PROPRE ET FONCTIONNEL
Scraper optimisé pour une catégorie spécifique d'Amazon
"""
...
class ScraperAmazon:
    def __init__(self, nom_categorie: str, url_recherche: str):
        """
        Initialise le scraper pour une catégorie spécifique
        
        Args:
            nom_categorie: Nom de la catégorie (ex: "Roman")
            url_recherche: URL de recherche Amazon (ex: "https://www.amazon.fr/s?k=roman&i=stripbooks")
        """
        self.nom_categorie = nom_categorie
        self.nom_fichier = nom_categorie.lower().replace(' ', '_').replace('é', 'e').replace('è', 'e')
